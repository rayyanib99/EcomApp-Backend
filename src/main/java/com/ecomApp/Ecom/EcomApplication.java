...
public class EcomApplication implements CommandLineRunner
{
	...
	public void run(String... args) throws Exception 
	{
		...
		productService.createProduct(new Product("Schwinn 22in  Mountain Bike", "https://tse1.mm.bing.net/th?id=OIP.j_xhcHLP7Wa98BPfjU7MzQHaFS&pid=Api&P=0", 299.99, "Sports", "", 0, "Straight from the warehouse to your door.", "New"));
		...
		// For Order 
		orderService.addOrder(new Orders(23.2, 2, "02/25/2022"));
